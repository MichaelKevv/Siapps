// @dart=2.9
import 'package:SiApps/adminApp/bayarSekolahAdmin/AddDataWidget.dart';
import 'package:SiApps/adminApp/bayarSekolahAdmin/Detail.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';

class BayarSekolahAdmin extends StatefulWidget {
  const BayarSekolahAdmin({Key key}) : super(key: key);

  @override
  _BayarSekolahAdminState createState() => _BayarSekolahAdminState();
}

class _BayarSekolahAdminState extends State<BayarSekolahAdmin> {
